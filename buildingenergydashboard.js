     ...
     layer.bindPopup
       (
                    feature.properties.property_n
                     ...
                     + '<p><b> Energy Star Rating: ' + feature.properties.energy_sta + '</b></p>'
                     + '<p><b> Site Energy Rating: ' + feature.properties.site_energ + '</b></p>'
...
function displayBuilding0(){
    document.getElementById('compare_div0').innerHTML =
            ...
            "<br/>" + "<b>"+" Energy Star Rating: "+"</b>" + properties_to_compare[0][2] +
...
function displayBuilding1(){
            ...
            "<br/>" + "<b>"+" Energy Star Rating: "+"</b>" + properties_to_compare[1][2] +
